	...
	const data = [
		{
			id: 1,
			name: "DentApp",
			title: `Добро пожаловать в будущее стоматологической заботы с нашим
		...
		},
		{
			...
			title: `	Добро пожаловать в мир инновационной текстильной автоматизации!
		...
		},
		{
			id: 3,
			name: "Cheber",
			title: `		Добро пожаловать в мир уникальной автоматизации для вашего
		...
		<section className={styles.section}>
			<div ref={onTopRef} className={styles.content}>
				...
				{/* <div className={styles.more_info}>
					<div ref={dentappRef} className={styles.dentapp}>
					...
					<div ref={breathRef} className={styles.breath}>
						...
						<div className={styles.title}>
							<p className={styles.phara}>
								Добро пожаловать в мир инновационной текстильной автоматизации!
								Представляем вам наше уникальное приложение, разработанное
								специально для оптимизации и улучшения производства в вашем
								швейном цехе. Связь в режиме реального времени: Наше приложение
								позволяет вам подключиться к вашему производству в любой точке
